...
<%
	...
	gargoyle_header_footer -h -s "status" -p "connections" -c "internal.css" -j "gs_sortable.js common.js conntrack.js table.js" -z "conntrack.js" -i -n uhttpd firewall qos_gargoyle
%>
