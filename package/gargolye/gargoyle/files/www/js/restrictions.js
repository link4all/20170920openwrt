...
function editRule()
{
	...
	editRuleWindow = window.open(editRuleType == "restriction_rule" ? "restriction_edit_rule.asp" : "whitelist_edit_rule.asp", "edit", "width=560,height=600,left=" + xCoor + ",top=" + yCoor );
