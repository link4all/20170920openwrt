...
function editRuleTableRow()
{
	...
	editRuleWindow = window.open("qos_edit_rule.asp", "test", "width=560,height=530,left=" + xCoor + ",top=" + yCoor );
	try
	{
...
function editClassTableRow()
{
	...
	editClassWindow = window.open("qos_edit_class.asp", "test", "width=560,height=500,left=" + xCoor + ",top=" + yCoor );
	try
	{
