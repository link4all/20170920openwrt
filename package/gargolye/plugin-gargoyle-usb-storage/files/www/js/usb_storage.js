...
function editUser()
{
	...
	editUserWindow = window.open("share_user_edit.asp", "edit", "width=560,height=230,left=" + xCoor + ",top=" + yCoor );
...
function editShare()
{
	...
	editShareWindow = window.open("usb_storage_edit.asp", "edit", "width=650,height=600,left=" + xCoor + ",top=" + yCoor );
