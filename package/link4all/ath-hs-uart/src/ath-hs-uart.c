...
void ath_hs_uart_init(void)
{
	...
	data = (data & ~GPIO_OUT_FUNCTION2_ENABLE_GPIO_11_MASK) |
		GPIO_OUT_FUNCTION2_ENABLE_GPIO_11_SET(0x4f);  //9344_ds.pdf "Table 2-16. GPIO Output Select Values" ,0x4f=79=UART1_TD ,
	ath_reg_wr(ATH_GPIO_OUT_FUNCTION2, data);

	//  UART1_RTS as outputs on 12
	...
	// Enabling UART1_RD as inputs on GPIO 21,	// GPIO_IN_ENABLE9
	data = ath_reg_rd(ATH_GPIO_OE);
	data = (data & 0xfffff7ff) | 0x200000;//0xf7ff of bit(11)=0, 0x200000 of bit(21)=1
	ath_reg_wr(ATH_GPIO_OE, data);
	ath_reg_wr(ATH_GPIO_IN_ENABLE9, 0x0150000);//0x150000 of bit16:23 =21 gpio21, 0x0b=11 gpio11
