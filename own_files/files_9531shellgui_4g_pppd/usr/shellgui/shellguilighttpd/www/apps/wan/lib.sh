...
EOF
	...
	uci set network.${FORM_wan}.proto="3g"
	uci set network.${FORM_wan}.device="$FORM_device"
	uci set network.${FORM_wan}.service="$FORM_service"
	uci set network.${FORM_wan}.apn="$FORM_apn"
	uci set network.${FORM_wan}.pincode="$FORM_pincode"
	uci set network.${FORM_wan}.dialnumber="$FORM_dialnumber"
