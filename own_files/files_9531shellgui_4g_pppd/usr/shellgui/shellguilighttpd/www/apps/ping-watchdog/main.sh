    			...
    			<form id="form_container">
					<div class="form-horizontal">
					  ...
					  <div class="form-group">
							...
							<div class="col-sm-8">
								<div class="input-group">
							  	<input type="number" min="1" max="59" data-validate="vaInt_1_59-vaLength" class="form-control" id="exec_interval" name="exec_interval" value=<%= ${exec_interval} %>>
					  ...
					  <div class="form-group">
							...
							<div class="col-sm-8">
								<div class="input-group">
							  	<input type="number" min="1" class="form-control" data-validate="vaInt_1-vaLength" id="delay_time" name="delay_time" value=<%= ${delay_time} %>>
					  ...
					  <div class="form-group">
							...
							<div class="col-sm-8">
							  <input type="number" min="1" class="form-control" data-validate="vaInt_1-vaLength" id="ping_count" name="ping_count" value=<%= ${ping_count} %>>
							  <span class="help-block hidden"><%= ${_LANG_Form_Please_enter_a_valid_} ${_LANG_Form_Positive_integer} %></span>
							</div> 
					  </div>
					  <div class="form-group">
					  ...
					  <div class="form-group <% ([ "$timeout_action" = "wan" ] || [ "$timeout_action" = "reboot" ]) && printf "hidden" %>" id="custom_script">
							...
							<div class="col-sm-8">
							  <input type="text" class="form-control" data-validate="vaPath-vaLength" id="script" name="script" value="<% [ "$timeout_action" = "wan" ] || [ "$timeout_action" = "reboot" ] || printf "$timeout_action" %>">
