						...
						<fieldset id="set_dnscdn_form">
							...
							<div id="allow_ports">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control" name="allow_tcp_ports" id="allow_tcp_ports" data-validate="vaMuliPorts" placeholder="80,22,105-109" value="<%= ${allow_tcp_ports} %>">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control" name="allow_udp_ports" id="allow_udp_ports"  data-validate="vaMuliPorts" placeholder="53,123" value="<%= ${allow_udp_ports} %>">
										<span class="help-block hidden"><%= ${_LANG_Form_Please_enter_a_valid_} ${_LANG_Form__Port_or_range} %></span>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control" name="allow_tcpudp_ports" id="allow_tcpudp_ports"  data-validate="vaMuliPorts" placeholder="21" value="<%= ${allow_tcpudp_ports} %>">
										<span class="help-block hidden"><%= ${_LANG_Form_Please_enter_a_valid_} ${_LANG_Form__Port_or_range} %></span>
									</div>
								</div>
							</div>
...
<% done %>
      ...
      <div class="app row app-item">
        ...
        <div class="col-sm-offset-2 col-sm-6 text-left">
					<div class="col-sm-8">
					  <div id="uploader-container" class="text-left" data-action="/apps/firewall-extra/upload.cgi" data-label="<%= ${_LANG_Form_Upload_GEOIP_Database_file} %>"></div>
					</div>
        </div>
      </div>
    </div>
