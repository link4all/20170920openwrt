    ...
    <div class="row">
        ...
        <form class="form-horizontal" name="doemail_main_setting" id="doemail_main_setting">
          <div class="form-group">
        	...
        	<div class="col-sm-8">
        	  <input type="text" class="form-control" data-validate="vaLength" name="MY_NAME" id="nickname" value="<%= ${mail_MY_NAME} %>">
          ...
          <div class="form-group">
        	...
        	<div class="col-sm-8">
        	  <input type="email" class="form-control" data-validate="vaLength-vaEmail" name="MY_EMAIL" id="email" placeholder="Email" value="<%= ${mail_MY_EMAIL} %>">
          ...
          <div class="form-group">
        	...
        	<div class="col-sm-8">
        	  <input type="text" class="form-control" data-validate="vaLength" name="SMTP_AUTH_USER" id="SMTP_AUTH_USER" placeholder="Username" value="<%= ${mail_SMTP_AUTH_USER} %>">
          ...
          <div class="form-group">
        	...
        	<div class="col-sm-8">
        	  <input type="password" class="form-control" data-validate="vaLength" name="SMTP_AUTH_PASS" id="SMTP_AUTH_PASS" placeholder="Password" value="<%= ${mail_SMTP_AUTH_PASS} %>">
          ...
          <div class="form-group">
        	...
        	<div class="col-sm-8">
        	  <input type="text" class="form-control" data-validate="vaLength" name="SMTP_SERVER" id="SMTP_SERVER" placeholder="SMTP Server IP" value="<%= ${mail_SMTP_SERVER} %>">
          ...
          <div class="form-group">
        	...
        	<div class="col-sm-8">
        	  <input type="number" class="form-control" data-validate="vaLength-vaPort" name="SMTP_PORT" id="SMTP_PORT" placeholder="SMTP Server Port" value="<%= ${mail_SMTP_PORT} %>">
          ...
          <div class="form-group">
        	...
        	<div class="col-sm-8">
        	  <textarea class="form-control" name="sig" data-validate="vaLength" id="sig" rows="5" placeholder="Signsture content"><% cat /usr/shellgui/shellguilighttpd/www/apps/notice/email/email.sig %></textarea>
          ...
          <div class="form-group">
        	...
        	<div class="col-sm-8">
        	  <input type="text" class="form-control" data-validate="vaLength" name="subject" id="subject" placeholder="Default subject" value="<%= ${mail_subject} %>">
        	...
        	<div class="form-group">
        		...
        		<div class="col-sm-8">
        			<div class="input-group">
        				<input type="number" class="form-control" data-validate="vaLength-vaInt" id="TIMEOUT" name="TIMEOUT" placeholder="20" value=<%= ${mail_TIMEOUT} %>>
        ...
        <form class="form-horizontal" name="email_extra_setting" id="email_extra_setting">
          ...
          <div class="form-group">
          	...
          	<div class="col-sm-8">
          	  <input type="email" class="form-control" data-validate="vaEmail" name="CC" id="CC" placeholder="example@example.com" value="<%= ${mail_CC} %>">
          ...
          <div class="form-group">
          	...
          	<div class="col-sm-8">
          	  <input type="email" class="form-control" data-validate="vaEmail" name="BCC" id="BCC" placeholder="example@example.com" value="<%= ${mail_BCC} %>">
              <span class="help-block hidden"><%= ${_LANG_Form_Please_enter_a_valid_} ${_LANG_Form_Addressee} %></span>
          	</div>
          </div>
          <div class="form-group">
        ...
        <form class="form-horizontal" name="email_test" id="email_test">
          ...
          <div class="form-group">
          	...
          	<div class="col-sm-8">
          	  <input type="email" class="form-control" data-validate="vaLength-vaEmail" name="Addressee" id="Addressee" placeholder="example@example.com" value="">
              <span class="help-block hidden"><%= ${_LANG_Form_Please_enter_a_valid_} ${_LANG_Form_Addressee} %></span>
          	</div>
          </div>
          <div class="form-group">
          	...
          	<div class="col-sm-8">
          	  <textarea class="form-control" data-validate="vaLength" name="email_test_content" id="sig" rows="5" placeholder="Test Mail content"><%= ${_LANG_Form_Email_content} %></textarea>
