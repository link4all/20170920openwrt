...
EOF
str_temp=$(echo '{"action":"notice_add_new","Notice":{"Dest_type":"app","Dest":"status","Desc":"_LANG_Notice_User_login_from","Detail":"_LANG_Notice_User_login_from_detail","Variable":{}}}' | jshon -e "Notice" -e "Variable" \
