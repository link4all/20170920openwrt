...
tab_like() { %>
      ...
      <div class="col-sm-12 adv_btn" style="cursor: pointer;" data-for="<%= ${wan} %>_adv_setting">
        <h4><small><span class="icon-plus"></span></small><%= ${_LANG_Form_Advanced} %>(<%= ${wan} %>)</h4>
      </div>
...
m_3g_like() { %>
      <div class="tab-content col-md-4">
          <form class="form-horizontal" name='3g' id="<%= ${wan} %>_3g" disabled>
              ...
              <div class="col-sm-9">
                <input type="text" disabled class="form-control" data-validate="vaLength" name="apn" id="<%= ${wan} %>_3g_apn" value="<%= `uci get config4g.@4G[0].apn` %>" placeholder="">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="text" disabled class="form-control"  name="pincode" id="<%= ${wan} %>_3g_pincode" value="<%= `uci get config4g.@4G[0].pincode` %>" placeholder="">
                <span class="help-block hidden"><%= ${_LANG_Form_Please_enter_a_valid_} %> PIN</span>
              </div>
            </div>
            <div class="form-group">
              <label for="dialnumber" class="col-sm-3 control-label"><%= ${_LANG_Form_DIALNUM} %></label>
              <div class="col-sm-9">
                <input type="text" disabled class="form-control" data-validate="vaLength" name="dialnumber" id="<%= ${wan} %>_3g_dialnumber" value="<%= `uci get config4g.@4G[0].dialnumber` %>" placeholder="*99#">
                <span class="help-block hidden"><%= ${_LANG_Form_Please_enter_a_valid_} %> DialNum</span>
              </div>
            </div>
            <div class="form-group">
              <label for="account" class="col-sm-3 control-label"><%= ${_LANG_Form_Username} %></label>
              <div class="col-sm-9">
                <input type="text" disabled class="form-control" id="<%= ${wan} %>_3g_username" name="username" value="<%= `uci get config4g.@4G[0].user` %>" placeholder="<%= ${_LANG_Form_Username} %>">
                <span class="help-block hidden"><%= ${_LANG_Form_Please_enter_a_valid_} ${_LANG_Form_Username} %></span>
              </div>
            </div>
            <div class="form-group">
              <label for="password" class="col-sm-3 control-label"><%= ${_LANG_Form_Password} %></label>
              <div class="col-sm-9">
                <input type="password" disabled class="form-control" name="password" id="<%= ${wan} %>_3g_password" value="<%= `uci get config4g.@4G[0].password` %>" placeholder="<%= ${_LANG_Form_Password} %>">
                <span class="help-block hidden"><%= ${_LANG_Form_Please_enter_a_valid_} ${_LANG_Form_Password} %></span>
              </div>
            </div>
               <div class="form-group">
              <label for="account" class="col-sm-3 control-label"><%= ${_LANG_Form_AUTHMODE} %></label>
              <div class="col-sm-9">
				<select name="auth" class="form-control">
					<option value="0" <% [ "`uci get config4g.@4G[0].auth`" = "0" ] && printf 'selected' %>>NONE</option>
					<option value="1" <% [ "`uci get config4g.@4G[0].auth`" = "1" ] && printf 'selected' %>>PAP</option>
					<option value="2" <% [ "`uci get config4g.@4G[0].auth`" = "2" ] && printf 'selected' %>>CHAP</option>
				</select>
              </div>
            </div>
            <div class="form-group">
