...
%>
					<tr id="wan_list_<%= ${wan} %>">
						...
						<td class="form-inline">
							<form>
							<div class="form-group">
								<input type="number" min="1" data-validate="vaInt_0_255-vaLength" class="form-control input-sm metric_input" id="<%= ${wan} %>_metric" value=<% uci get network.${wan}.metric %>>
								<button type="submit" class="btn btn-sm btn-default metric_btn" id="submit_<%= ${wan} %>"><%= ${_LANG_Form_Apply} %></button>
						...
						<td>
							<a href="/?app=mwan3&amp;action=edit_wan&wan=<%= ${wan} %>"><button class="btn btn-sm btn-default"><%= ${_LANG_Form_Edit} %></button></a>
...
%>
				<tr id="member_list_<%= ${member} %>">
					...
					<td>
						<a href="/?app=mwan3&amp;action=edit_member&member=<%= ${member} %>"><button class="btn btn-sm btn-default"><%= ${_LANG_Form_Edit} %></button></a>
...
%>
				<tr id="policy_list_<%= ${policy} %>">
					...
					<td>
						<a href="/?app=mwan3&amp;action=edit_policy&policy=<%= ${policy} %>"><button class="btn btn-sm btn-default"><%= ${_LANG_Form_Edit} %></button></a>
...
%>
				<tr id="rule_list_<%= ${rule} %>">
					...
					<td>
						<a href="/?app=mwan3&amp;action=edit_rule&rule=<%= ${rule} %>"><button class="btn btn-sm btn-default"><%= ${_LANG_Form_Edit} %></button></a>
...
<div class="col-sm-offset-2 col-sm-6 text-left">
	...
	<fieldset>
		...
		<div class="form-group">
			...
			<div class="col-sm-8">
				<input type="text" class="form-control" id="track_ip" name="track_ip" required data-validate="vaIPs-vaLength" value="<%= $(echo "$track_ip" | sed 's#[ ][ ]*#,#g') %>">
		...
		<div class="form-group">
			...
			<div class="col-sm-8">
				<div class="input-group">
				  <input type="number" min="1" required data-validate="vaInt_1-vaLength" id="count_input" class="form-control" value=<%= ${count} %> name="count">
		...
		<div class="form-group">
			...
			<div class="col-sm-8">
				<div class="input-group">
				  <input type="number" min="1" required data-validate="vaInt_1-vaLength" id="timeout_input" class="form-control" value=<%= ${timeout} %> name="timeout">
		...
		<label class="col-sm-4 control-label"><%= ${_LANG_Form_Ping_test_interval} %></label>
			<div class="col-sm-8">
				<div class="input-group">
				  <input type="number" min="1" required data-validate="vaInt_1-vaLength" id="interval_input" class="form-control" value=<%= ${interval} %> name="interval">
				  <span class="input-group-addon"><%= ${_LANG_Form_Secs} %></span>
				</div>
				<span class="help-block hidden"><%= ${_LANG_Form_Please_enter_a_valid_} ${_LANG_Form_Positive_integer} %></span>
			</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-8">
				<div class="input-group">
				  <input type="number" min="1" required data-validate="vaInt_1-vaLength" id="reliability_input" class="form-control" value=<%= ${reliability} %> name="reliability">
				  <span class="input-group-addon"><%= ${_LANG_Form_Secs} %></span>
				</div>
				<span class="help-block hidden"><%= ${_LANG_Form_Please_enter_a_valid_} ${_LANG_Form_Positive_integer} %></span>
			</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-8">
				<div class="input-group">
				  <input type="number" min="1" required data-validate="vaInt_1-vaLength" id="down_input" class="form-control" value=<%= ${down} %> name="down">
				  <span class="input-group-addon">次</span>
				</div>
				<span class="help-block hidden"><%= ${_LANG_Form_Please_enter_a_valid_} ${_LANG_Form_Positive_integer} %></span>
			</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-8">
				<div class="input-group">
				  <input type="number" min="1" required data-validate="vaInt_1-vaLength" id="up_input" class="form-control" value=<%= ${up} %> name="up">
				  <span class="input-group-addon">次</span>
				</div>
				<span class="help-block hidden"><%= ${_LANG_Form_Please_enter_a_valid_} ${_LANG_Form_Positive_integer} %></span>
			</div>
...
<% done %>
		...
		<div class="form-group">
			...
			<div class="col-sm-8">
				<div class="input-group">
				  <input type="number" min="1" data-validate="vaInt_1_1000-vaLength" id="metric_input" class="form-control" value=<%= ${metric:-1} %> name="metric">
		...
		<div class="form-group">
			...
			<div class="col-sm-8">
				<div class="input-group">
				  <input type="number" min="1" data-validate="vaInt_1_1000-vaLength" id="weight_input" class="form-control" value=<%= ${weight:-1} %> name="weight">
...
<div class="col-sm-offset-2 col-sm-6 text-left">
	...
	<fieldset>
		...
		<div class="form-group">
			...
			<div class="col-sm-8">
				<input type="text" class="form-control" data-validate="vaIPS" value="<%= ${src_ip} %>" name="src_ip" id="src_ip_input">
		...
		<div class="form-group">
			...
			<div class="col-sm-8">
				<input type="text" class="form-control input-sm" data-validate="vaPorts" name="src_port" value="<%= ${src_port} %>" id="src_port_input">
		...
		<div class="form-group">
			...
			<div class="col-sm-8">
				<input type="text" class="form-control" data-validate="vaIPS" value="<%= ${dest_ip} %>" name="dest_ip" id="dest_ip_input">
				<span class="help-block hidden"><%= ${_LANG_Form_IP_or_IP__Mask} %></span>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-8">
				<input type="text" class="form-control input-sm" data-validate="vaPorts" name="dest_port" value="<%= ${dest_port} %>" id="dest_port_input">
				<span class="help-block hidden"><%= ${_LANG_Form_Please_enter_a_valid_} %> 端口值(1-65535)，多个端口之间用逗号分隔</span>
			</div>
		</div>
		<div class="form-group">
...
<% done %>
		...
		<div class="form-group">
			...
			<div class="col-sm-8">
				<input type="number" min="1" class="form-control input-sm" data-validate="vaInt_1" name="timeout" id="timeout_input" value=<%= ${timeout} %>>
				<span class="help-block hidden"><%= ${_LANG_Form_Please_enter_a_valid_} ${_LANG_Form_Positive_integer} %></span>
			</div>
		</div>
		<div class="form-group">
