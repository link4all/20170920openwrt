...
. /www/data/lang/$lang/macfilter.po
%>
...
<link rel="stylesheet" type="text/css" href="css/form.css" />
  ...
  function setlan(){
        ...
          success: function(json) {
             ...
             $("#status").html("<%= $mac_error%>");
             }else{
                $("#status").html("<%= $finish_mac%>");
             }
          },
            ...
            <div class="wrap-form">
             <form class="form-info" id="form0">
                    ...
                    <label class="">
                            ...
                            <div>
<textarea  rows="8" cols="50"  name="maclist" >
<% uci -q get firewall.macfilter.maclist |sed 's/ /|/g' %>
</textarea>
                            </div>
                        </label>
                  </form>
