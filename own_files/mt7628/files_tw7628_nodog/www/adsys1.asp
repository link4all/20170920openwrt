            ...
            <div class="wrap-form">
             <form class="form-info" id="form0">
               <label >
                   ...
                   <div>
                       <input  name="enable" type="checkbox" value="1" <% [ `uci get nodogsplash.@nodogsplash[0].enabled ` = "1" ] && echo checked %>" />
                   </div>
               </label>
                    <label >
                        <div class="name"><%= $reauth_time%>：</div>
                        <div>
                            <input  name="timeout" type="text" value="<%  uci get nodogsplash.@nodogsplash[0].clientforcetimeout %>" />
                        </div>
                    </label>
                    <label >
                        <div class="name"><%= $redirecturl%>：</div>
                        <div>
                            <input  name="redirurl" type="text" value="<%  uci get nodogsplash.@nodogsplash[0].redirecturl %>" />
                        </div>
                    </label>
<!--                    <label >
