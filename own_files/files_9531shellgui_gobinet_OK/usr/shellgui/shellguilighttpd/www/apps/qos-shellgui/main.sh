  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
          ...
          <fieldset>
            ...
            <div class="form-group">
              <div class="col-sm-5">
                ...
                <div class="col-sm-7">
                  <div>
                    <input type="text" class="form-control" data-validate="vaIP-vaLength" id="source_ip" name="Source_IP" disabled required>
                    <span class="help-block hidden"><%= ${_LANG_Form_Please_enter_a_valid_} ${_LANG_Form_IP_Address} %></span>
                  </div>
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-7">
                  <div>
                    <input type="text" class="form-control" data-validate="vaPort-vaLength" id="source_port" name="Source_Ports" disabled required>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-7">
                  <div>
                    <input type="text" class="form-control" data-validate="vaIP-vaLength" id="destination_ip" name="Destination_IP" disabled required>
                    <span class="help-block hidden"><%= ${_LANG_Form_Please_enter_a_valid_} ${_LANG_Form_IP_Address} %></span>
                  </div>
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-7">
                  <div>
                    <input type="text" class="form-control" data-validate="vaPort-vaLength" id="destination_port" name="Destination_Ports" disabled required>
                    <span class="help-block hidden"><%= ${_LANG_Form_Please_enter_a_valid_} ${_LANG_Form__Port} %></span>
                  </div>
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-7 has-feedback">
                  <div class="input-group">
                    <input type="text" class="form-control" data-validate="vaPort-vaLength" id="max_packet_length" name="Maximum_Packet_Length" disabled required>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-7 has-feedback">
                  <div class="input-group">
                    <input type="text" class="form-control" data-validate="vaPort-vaLength" id="min_packet_length" name="Minimum_Packet_Length" disabled required>
                    <span class="input-group-addon">bytes</span>
                  </div>
                  <span class="help-block hidden"><%= ${_LANG_Form_Please_enter_a_valid_} ${_LANG_Form__Packet_length} %></span>
                </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-7 has-feedback">
                  <div class="input-group">
                    <input type="text" class="form-control" id="bytes_reach" data-validate="vaInt_1-vaLength" name="Connection_bytes_reach" disabled required>
      ...
      <div class="modal-footer">
        <button type="submit" class="btn btn-default" id="submit_rule_btn" data-type="submit_btn"><%= ${_LANG_Form_Apply} %></button>
...
<div class="modal fade" id="classModal" tabindex="-1">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
          <fieldset>
            <div class="form-group">
              ...
              <div class="col-sm-7">
                <div>
                  <input type="text" class="form-control" data-validate="vaLength" required id="service_class_name" name="name">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-7 has-feedback">
                <div class="input-group">
                  <input type="text" class="form-control" data-validate="vaInt_1_100-vaLength" required id="percent_bandwidth" name="percent">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-7 has-feedback">
                <div class="input-group">
                  <input type="text" class="form-control" data-validate="vaInt_1-vaLength" id="bandwidth_min" name="min_bw" disabled>
                  <span class="input-group-addon">kbits/s</span>
                </div>
                <span class="help-block hidden"><%= ${_LANG_Form_Please_enter_a_valid_} ${_LANG_Form_Positive_integer} %></span>
              </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-7 has-feedback">
                <div class="input-group">
                  <input type="text" class="form-control"  data-validate="vaInt_1-vaLength" id="bandwidth_max" name="max_bw" disabled>
                  <span class="input-group-addon">kbits/s</span>
                </div>
                <span class="help-block hidden"><%= ${_LANG_Form_Please_enter_a_valid_} ${_LANG_Form_Positive_integer} %></span>
              </div>
      ...
      <div class="modal-footer">
        <button type="submit" class="btn btn-default" id="submit_class_btn" data-type="submit_btn"><%= ${_LANG_Form_Apply} %></button>
        <button type="button" class="btn btn-warning" data-dismiss="modal"><%= ${_LANG_Form_Cancel} %></button>
      </div>
      </form>
    </div>
...
<div class="modal fade" id="ruleModal" tabindex="-1">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
          ...
          <fieldset>
            ...
            <div class="form-group">
              <div class="col-sm-5">
                ...
                <div class="col-sm-7">
                  <div>
                    <input type="text" data-validate="vaIP-vaLength" class="form-control" id="source_ip" name="Source_IP" disabled required>
                    <span class="help-block hidden"><%= ${_LANG_Form_Please_enter_a_valid_} ${_LANG_Form_IP_Address} %></span>
                  </div>
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-7">
                  <div>
                    <input type="text" data-validate="vaPort-vaLength" class="form-control" id="source_port" name="Source_Ports" disabled required>
                    <span class="help-block hidden"><%= ${_LANG_Form_Please_enter_a_valid_} ${_LANG_Form__Port} %></span>
                  </div>
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-7">
                  <div>
                    <input type="text" data-validate="vaIP-vaLength" class="form-control" id="destination_ip" name="Destination_IP" disabled required>
                    <span class="help-block hidden"><%= ${_LANG_Form_Please_enter_a_valid_} ${_LANG_Form_IP_Address} %></span>
                  </div>
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-7">
                  <div>
                    <input type="text" data-validate="vaPort-vaLength" class="form-control" id="destination_port" name="Destination_Ports" disabled required>
                    <span class="help-block hidden"><%= ${_LANG_Form_Please_enter_a_valid_} ${_LANG_Form__Port} %></span>
                  </div>
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-7 has-feedback">
                  <div class="input-group">
                    <input type="text" data-validate="vaPort-vaLength" class="form-control" id="max_packet_length" name="Maximum_Packet_Length" disabled required>
                    <span class="input-group-addon">bytes</span>
                  </div>
                  <span class="help-block hidden"><%= ${_LANG_Form_Please_enter_a_valid_} ${_LANG_Form__Packet_length} %></span>
                </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-7 has-feedback">
                  <div class="input-group">
                    <input type="text" data-validate="vaPort-vaLength" class="form-control" id="min_packet_length" name="Minimum_Packet_Length" disabled required>
                    <span class="input-group-addon">bytes</span>
                  </div>
                  <span class="help-block hidden"><%= ${_LANG_Form_Please_enter_a_valid_} ${_LANG_Form__Packet_length} %></span>
                </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-7 has-feedback">
                  <div class="input-group">
                    <input type="text" data-validate="vaInt_1-vaLength" class="form-control" id="bytes_reach" name="Connection_bytes_reach" disabled required>
                    <span class="input-group-addon">kBytes</span>
                  </div>
                  <span class="help-block hidden"><%= ${_LANG_Form_Please_enter_a_valid_} ${_LANG_Form_Positive_integer} %></span>
                </div>
      ...
      <div class="modal-footer">
        <button type="submit" class="btn btn-default" data-type="submit_btn" id="submit_rule_btn"><%= ${_LANG_Form_Apply} %></button>
        <button type="button" class="btn btn-warning" data-dismiss="modal"><%= ${_LANG_Form_Cancel} %></button>
      </div>
      </form>
    </div>
...
<div class="modal fade" id="classModal" tabindex="-1">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
          <fieldset>
            <div class="form-group">
              ...
              <div class="col-sm-7">
                <div>
                  <input type="text" data-validate="vaLength" class="form-control" id="service_class_name" name="name">
                  <span class="help-block hidden"><%= ${_LANG_Form_Please_enter_a_valid_} ${_LANG_Form_Service_Classes_Name} %></span>
                </div>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-sm-7 has-feedback">
                <div class="input-group">
                  <input type="text" data-validate="vaInt_1_100-vaLength" class="form-control" id="percent_bandwidth" name="percent">
                  <span class="input-group-addon">%</span>
                </div>
                <span class="help-block hidden"><%= ${_LANG_Form_Please_enter_a_valid_} ${_LANG_Form_Positive_integer} %>(1-100)</span>
              </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-7 has-feedback">
                <div class="input-group">
                  <input type="text" data-validate="vaInt_1-vaLength" class="form-control" id="bandwidth_min" name="min_bw" disabled>
                  <span class="input-group-addon">kbits/s</span>
                </div>
                <span class="help-block hidden"><%= ${_LANG_Form_Please_enter_a_valid_} ${_LANG_Form_Positive_integer} %></span>
              </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-7 has-feedback">
                <div class="input-group">
                  <input type="text" data-validate="vaInt_1-vaLength" class="form-control" id="bandwidth_max" name="max_bw" disabled>
                  <span class="input-group-addon">kbits/s</span>
                </div>
                <span class="help-block hidden"><%= ${_LANG_Form_Please_enter_a_valid_} ${_LANG_Form_Positive_integer} %></span>
              </div>
      ...
      <div class="modal-footer">
        <button type="submit" class="btn btn-default" data-type="submit_btn" id="submit_class_btn"><%= ${_LANG_Form_Apply} %></button>
        <button type="button" class="btn btn-warning" data-dismiss="modal"><%= ${_LANG_Form_Cancel} %></button>
      </div>
      </form>
    </div>
...
<div class="content row">
  <div class="col-sm-6 app">
    ...
    <div class="btn-group" id="down-btns">
      <button class="btn btn-sm btn-default active" data-value="1"><%= ${_LANG_Form_minutes} %></button>
      <button class="btn btn-sm btn-default" data-value="2"><%= ${_LANG_Form_quarter_hours} %></button>
      <button class="btn btn-sm btn-default" data-value="3"><%= ${_LANG_Form_hours} %></button>
      <button class="btn btn-sm btn-default" data-value="4"><%= ${_LANG_Form_days} %></button>
      <button class="btn btn-sm btn-default" data-value="5"><%= ${_LANG_Form_months} %></button>
    </div>
    <a href="/?app=qos-shellgui&action=download_class"><button class="btn btn-sm btn-primary"><span class="icon-set"></span></button></a>
    <div id="down" class="pie-container"></div>
    <div id="down-label-container" class="text-center"></div>
  </div>
  <div class="col-sm-6 app">
    <h2 class="app-sub-title"><%= ${_LANG_Form_Upload_Setting} %></h2>
    <div class="hidden">
      <select id="up_timeframe">
        <option value="1" selected><%= ${_LANG_Form_minutes} %></option>
        <option value="2"><%= ${_LANG_Form_quarter_hours} %></option>
        <option value="3"><%= ${_LANG_Form_hours} %></option>
        <option value="4"><%= ${_LANG_Form_days} %></option>
    ...
    <div class="btn-group" id="up-btns">
      <button class="btn btn-sm btn-default active" data-value="1"><%= ${_LANG_Form_minutes} %></button>
      <button class="btn btn-sm btn-default" data-value="2"><%= ${_LANG_Form_quarter_hours} %></button>
      <button class="btn btn-sm btn-default" data-value="3"><%= ${_LANG_Form_hours} %></button>
      <button class="btn btn-sm btn-default" data-value="4"><%= ${_LANG_Form_days} %></button>
    ...
    <a href="/?app=qos-shellgui&action=upload_class"><button class="btn btn-sm btn-primary"><span class="icon-set"></span></button></a>
    <div id="up" class="pie-container"></div>
    <div id="up-label-container" class="text-center"></div>
  </div>
  <hr>
...
<script src="/apps/qos-shellgui/pieChart.js"></script>
