...
%>
            <div class="col-sm-9">
              <div class="input-group">
                ...
                <input type="number" class="form-control" id="startip_<%= ${lan} %>" name="start" value="<%= $start %>" maxlength="3">
              </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9">
              <div class="input-group">
                <input type="number" class="form-control" id="allow_<%= ${lan} %>" name="limit" value="<%= $limit %>">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9">
              <input type="number" class="form-control" id="time_<%= ${lan} %>" name="leasetime" value=<% printf $leasetime | grep -Eo '[0-9]*' %> maxlength="6">
              <span class="help-block hidden"><%= ${_LANG_Form_Please_enter_a_valid_} ${_LANG_Form_Positive_integer} %></span>
            </div>
          </div>
          <div class="form-group">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="submit" class="btn btn-primary" id="confirm_submit" data-dismiss="modal"><%= ${_LANG_Form_Apply} %></button>
