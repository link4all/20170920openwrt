...
<div class="table-responsive">
	<table class="table">
		...
		<tbody>
<%
table_str=$(awk 'NR==FNR{a[FNR]=$0;next}{print a[FNR] ":" $0}' /etc/passwd /etc/shadow | awk -F ":" '{if ($1 == "root") print "<tr id=\""$1"\"><td>"$3"</td><td>"$1"</td><td class=\"user_pwd\" style=\"width: 20%\">"$9"</td><td>:"$4":</td><td>"$5"</td><td>"$6"</td><td>"$7"</td><td><button data-user=\""$1"\" data-toggle=\"modal\" data-target=\"#editUserModal\" class=\"btn btn-primary btn-xs edit_user_btn\">'"${_LANG_Form_Edit}"'</button></td></tr>";else print "<tr id=\""$1"\"><td>"$3"</td><td>"$1"</td><td class=\"user_pwd\" style=\"width: 20%\">"$9"</td><td>:"$4":</td><td>"$5"</td><td>"$6"</td><td>"$7"</td><td><button data-toggle=\"modal\" data-user=\""$1"\" data-target=\"#editUserModal\" class=\"btn btn-primary btn-xs edit_user_btn\">'"${_LANG_Form_Edit}"'</button><button class=\"btn btn-danger btn-xs del_user_btn\" data-toggle=\"modal\" data-target=\"#confirmModal\">'"${_LANG_Form_Del}"'</button></td></tr>"}')
  ...
  <div class="modal-dialog">
	...
	<form class="form-horizontal" id="user_form">
      ...
      <div class="modal-footer">
        <button type="submit" class="btn btn-default" id="submit_user_btn" data-dismiss="modal">Save</button>
...
echo "$group_main" | awk -F ":" {'print "<tr id=\""$1"\"><td>"$1"</td><td>"$3"</td><td>"$5"</td><td><button class=\"btn btn-primary btn-xs edit_group_btn\" data-group=\""$1"\" data-gid=\""$3"\" data-toggle=\"modal\" data-target=\"#editGroupModal\">'"${_LANG_Form_Edit}"'</button></td></tr>"'}
echo "$group_pre_supplemental" | awk -F ":" {'print "<tr id=\""$1"\"><td>"$1"</td><td>"$3"</td><td></td><td><button class=\"btn btn-primary btn-xs edit_group_btn\" data-group=\""$1"\" data-gid=\""$3"\" data-toggle=\"modal\" data-target=\"#editGroupModal\">'"${_LANG_Form_Edit}"'</button><button class=\"btn btn-danger btn-xs del_group_btn\" data-toggle=\"modal\" data-target=\"#confirmModal\">'"${_LANG_Form_Del}"'</button></td></tr>"'}
%>
		</tbody>
	</table>
</div>
