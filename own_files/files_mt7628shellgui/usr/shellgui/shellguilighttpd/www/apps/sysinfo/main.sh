...
%>
							...
							<div class="form-group">
								...
								<div class="col-sm-7">
									<input type="number" min="1" max="65535" class="form-control" name="web_ctl_port" id="web_ctl_port" value=<% grep '^server.port' /usr/shellgui/shellguilighttpd/etc/lighttpd/lighttpd.conf | grep -Eo '[0-9]*$' %>>
