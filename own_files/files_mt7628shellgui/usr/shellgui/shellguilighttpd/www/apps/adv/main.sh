    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="submit" class="btn btn-primary" id="add_dhcp_btn"><%= ${_LANG_Form_Confirm} %></button>
...
EOF
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                <input type="number" class="form-control" id="ddns-check-interval" name="check_interval" value="10">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                <input type="number" class="form-control" id="ddns-force-update" name="force_interval" value="0">
        ...
        <div class="modal-footer">
          <button type="submit" class="btn btn-primary" id="submit_ddns_btn" data-submit-target='add'><%= ${_LANG_Form_Confirm} %></button>
          <button type="button" class="btn btn-warning" data-dismiss="modal"><%= ${_LANG_Form_Cancel} %></button>
        </div>
      </div>
    </div>
  ...
  <div class="modal fade" id="portForwardingModal" tabindex="-1">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form class="form" id="add_portfw_form">
            ...
            <div class="form-group">
              ...
              <input type="number" class="form-control" id="outer-port" name="src_dport">
            ...
            <div class="form-group">
              ...
              <input type="number" class="form-control" id="inner-port" name="dest_port">
              <span class="help-block hidden"><%= ${_LANG_Form_Please_enter_a_valid_} ${_LANG_Form__Port} %></span>
            </div>
        ...
        <div class="modal-footer">
          <button type="submit" class="btn btn-primary" id="submit_portfw_btn" data-submit-target='add'><%= ${_LANG_Form_Confirm} %></button>
          <button type="button" class="btn btn-warning" data-dismiss="modal"><%= ${_LANG_Form_Cancel} %></button>
        </div>
      </div>
    </div>
  ...
  <div class="modal fade" id="rangeForwardingModal" tabindex="-1">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form class="form" id="add_rangefw_form">
            ...
            <div class="form-group">
              ...
              <input type="number" class="form-control" id="start-port" name="start_port">
              <span class="help-block hidden"><%= ${_LANG_Form_Please_enter_a_valid_} ${_LANG_Form__Port} %></span>
            </div>
            <div class="form-group">
              <label for="end-port" class="control-label"><%= ${_LANG_Form_End_port} %>:</label>
              <input type="number" class="form-control" id="end-port" name="end_port">
              <span class="help-block hidden"><%= ${_LANG_Form_Please_enter_a_valid_} ${_LANG_Form__Port} %></span>
            </div>
            <div class="form-group">
        ...
        <div class="modal-footer">
          <button type="submit" class="btn btn-primary" id="submit_rangefw_btn" data-submit-target='add'><%= ${_LANG_Form_Confirm} %></button>
          <button type="button" class="btn btn-warning" data-dismiss="modal"><%= ${_LANG_Form_Cancel} %></button>
        </div>
      </div>
    </div>
