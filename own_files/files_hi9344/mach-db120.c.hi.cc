...
#define DB120_GPIO_LED_WLAN_5G		13
#define DB120_GPIO_LED_WLAN_2G		14
#define DB120_GPIO_LED_STATUS		12
...
//add gpio_output function
	ath79_gpio_output_select(DB120_GPIO_LED_WLAN_2G, AR934X_GPIO_OUT_GPIO);
	ath79_gpio_output_select(DB120_GPIO_LED_STATUS, AR934X_GPIO_OUT_GPIO);
...
ath79_setup_ar934x_eth_cfg(AR934X_ETH_CFG_SW_ONLY_MODE);
	...
	//ath79_init_mac(ath79_eth0_data.mac_addr, art + DB120_MAC0_OFFSET, 0);
	 ath79_init_mac(ath79_eth1_data.mac_addr, art + DB120_WMAC_CALDATA_OFFSET + 2, 0);
	...
	ath79_register_eth(1);
#endif
	ath79_init_mac(ath79_eth0_data.mac_addr, art + DB120_WMAC_CALDATA_OFFSET + 2, 0);
